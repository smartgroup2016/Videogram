...
public class LoginActivity1 extends BaseActivity {
    ...
    private void initProgressDialog() {
        progressDialog = new ProgressDialog(this) {
            ...
            public void onBackPressed() {
               // Toast.makeText(LoginActivity1.this, getString(R.string.wait_until_login_finish), Toast.LENGTH_SHORT).show();
            }
        };
    ...
    private void startOpponentsActivity(){
        Intent intent = new Intent(LoginActivity1.this, OpponentsActivity.class);
