...
public class OpponentsActivity extends BaseActivity {
    ...
    private void initOpponentListAdapter() {
        ...
        hideProgressDialog();
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(OpponentsActivity.this);
            builder.setTitle("Sorry!");  // заголовок
            builder.setMessage("User not available");
            builder.setNegativeButton("Ok", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int id) {
                    Intent inte = new Intent(ApplicationLoader.applicationContext, LaunchActivity.class);
                    startActivity(inte);
                    finish();
                }
            });
        ...
        List<QBUser> users = getOpponentsList();
            ...
            /*if (!isWifiConnected){
               ...
               // setActionButtonsClickable(true);
                ...
                CallActivity1.start(this, qbConferenceType, getOpponentsIds(users),
