 ...
 */
public class IncomeCallListenerService1 extends Service implements QBRTCClientSessionCallbacks, QBRTCClientConnectionCallbacks {

    private static final String TAG = IncomeCallListenerService1.class.getSimpleName();
   ...
   /* @TargetApi(Build.VERSION_CODES.JELLY_BEAN)
    private Notification createNotification() {
        ...
        Intent notificationIntent = new Intent(context, LoginActivity1.class);
        ...
        if (!TextUtils.isEmpty(login) && !TextUtils.isEmpty(password)) {
            ...
            QBAuth.createSession(login, password, new QBEntityCallbackImpl<QBSession>() {
                    ...
                    if (chatService.isLoggedIn()) {
                        ...
                        chatService.login(user, new QBEntityCallbackImpl<QBUser>() {
                            ...
                            public void onError(List errors) {
                                ...
                                Toast.makeText(IncomeCallListenerService1.this, "Error when login", Toast.LENGTH_SHORT).show();
                ...
                public void onError(List<String> errors) {
                    ...
                    sendResultToActivity(false);
                    Toast.makeText(IncomeCallListenerService1.this, "Error when login, check test users login and password", Toast.LENGTH_SHORT).show();
                }
            });
        } else {
            sendResultToActivity(false);
            stopForeground(true);
            stopService(new Intent(getApplicationContext(), IncomeCallListenerService1.class));
        }
    }
    ...
    private void startOpponentsActivity(){
        ...
        if (startServiceVariant != Consts.AUTOSTART) {
            if (AndroidUtilities.isTablet()){
                intent = new Intent(IncomeCallListenerService1.this, OpponentActivityTablet.class);
            }else {
                intent = new Intent(IncomeCallListenerService1.this, OpponentsActivity.class);
            }
    ...
    private void sendResultToActivity (boolean isSuccess){
        ...
        if (startServiceVariant == Consts.LOGIN) {
            try {
                ...
                pendingIntent.send(IncomeCallListenerService1.this, Consts.LOGIN_RESULT_CODE, intent);
    ...
    public void onReceiveNewSession(QBRTCSession qbrtcSession) {
        if (SessionManager.getCurrentSession() == null){
            ...
            if (AndroidUtilities.isTablet()){
                CallActivity1Tablet.start(this,
